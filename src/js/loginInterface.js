...
class LoginForm {
	constructor(controller) {
		...
		this.div = addElement('div', 'login-form', wpage);
...
class CreateAccountForm {
	constructor(controller) {
        ...
        this.t3 = addElementTxt('h3', 'tag', this.div, "Login:");
        this.newLoginInput = addElement('input', 'login-input mbot20', this.div);
        this.t4 = addElementTxt('h3', 'tag', this.div, "Password:");
        this.password1Input = addElement('input', 'login-input mbot20', this.div);
        this.password1Input.setAttribute('type', 'password');
        this.t5 = addElementTxt('h3', 'tag', this.div, "Repeat Password:");
        this.password2Input = addElement('input', 'login-input mbot20', this.div);
        this.password2Input.setAttribute('type', 'password');
        this.t6 = addElementTxt('h3', 'tag', this.div, "Email:");
        this.emailInput = addElement('input', 'login-input', this.div);

        this.newFeedbackDiv = addElement('div', 'feedback hidden', this.div);
        this.createButton = addElementTxt('button', 'mtop20 mbot20', this.div, "Create Account");
